      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          >
            ...
            {/* Key Trust Points */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2 text-sm sm:text-base text-slate-300">
            ...
            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              ...
              <Link
                href="/products"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-4 rounded-full text-sm sm:text-base font-semibold text-slate-200 hover:text-white border border-slate-700 hover:border-slate-500 bg-slate-900/60 backdrop-blur-sm transition-all hover:bg-slate-800/80"
              >
            ...
            <div className="pt-3 flex items-center justify-center lg:justify-start gap-6 text-xs sm:text-sm text-slate-300">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/10 bg-slate-900 shadow-2xl">
                ...
                <div className="relative h-96 sm:h-[460px] w-full overflow-hidden group">
                  <img
                    ...
                    alt="High fashion organic apparel manufacturing"
                    className="w-full h-full object-cover object-center group-hover:scale-105 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent" />
                  
                  {/* Floating Metric Badge */}
                  <div className="absolute top-4 right-4 backdrop-blur-md bg-slate-950/80 border border-amber-500/30 rounded-xl p-3.5 shadow-lg">
                    <p className="text-xs uppercase font-bold text-amber-400 tracking-wider">AQL 1.5 Quality</p>
                    <p className="text-xl font-bold text-white">99.4% Pass Rate</p>
                  </div>

                  {/* Floating Bottom Card */}
                  <div className="absolute bottom-4 left-4 right-4 backdrop-blur-md bg-slate-950/85 border border-white/10 rounded-xl p-4 sm:p-5 space-y-2.5">
