    ...
    <Card hoverEffect className="p-5 sm:p-6 transition-all border-border/80 bg-card/80 hover:border-primary/40">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div className="space-y-2.5 max-w-xl">
          ...
          <div>
            <h3 className="text-base sm:text-lg font-semibold text-foreground tracking-tight hover:text-primary transition-colors">
        ...
        <div className="w-full lg:w-64 space-y-2 pt-2 lg:pt-0 border-t lg:border-t-0 border-border/50">
          ...
          <div className="flex items-center justify-between text-[11px] text-muted-foreground">
            <span className="flex items-center gap-1">
              ...
              Ex-Factory: <strong className="text-foreground font-mono">{order.exFactoryDate}</strong>
            </span>
            {order.shipmentDate && (
